...
package im.ene.zcustomvideoview.views;

import im.ene.zcustomvideoview.R;
...
public class VideoControllerView extends FrameLayout {
	...
	private void initControllerView(View v) {
		...
		mFullscreenButton = (ImageButton) v
				.findViewById(R.id.fullscreen_toggle);
	...
	public void updateFullScreen() {
		...
		if (mPlayer.isFullScreen()) {
			mFullscreenButton
					.setImageResource(R.drawable.ic_vidcontrol_fullscreen_on);
		} else {
			mFullscreenButton
					.setImageResource(R.drawable.ic_vidcontrol_fullscreen_off);
		}
	}
