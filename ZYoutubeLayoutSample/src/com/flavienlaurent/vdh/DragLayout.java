...
public class DragLayout extends LinearLayout {
	...
	private class DragHelperCallback extends ViewDragHelper.Callback {
		...
		public void onViewPositionChanged(View changedView, int left, int top,
				int dx, int dy) {
			mDragOffset = (float) left / mHorizontalDragRange;
			mDragView1.setAlpha(1 - mDragOffset);
			invalidate();
//			requestLayout();
		}
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		mHorizontalDragRange = getWidth() - mDragView1.getWidth();
		mDragView1.layout(l, 0, mDragView1.getMeasuredWidth() + l,
				mDragView1.getMeasuredHeight());
	}
}
